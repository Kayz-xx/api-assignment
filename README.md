...
Note: The markdown document was formatted by an LLM. I used Gemini to assist with Jest setup (CommonJS vs ESM) as a quicker way to setup a working test environment.
